$(document).ready(function() {
  ...
  $(".btn-green-peppers").click(function() {
    ...
    $(".green-pepper").toggle();
    $("aside li")
      .filter(":contains('$1 green peppers')")
      .toggle();
    printOutPrice();
  });
  $(".btn-crust").click(function() {
    ...
    $("aside li")
      .filter(":contains('$5 gluten-free crust')")
      .toggle();
    printOutPrice();
  });
